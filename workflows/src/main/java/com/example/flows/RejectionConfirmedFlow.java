...
public class RejectionConfirmedFlow {

    @InitiatingFlow
    @StartableByRPC
    public static class RejectionConfirmedFlowInitiator extends FlowLogic<SignedTransaction>{
        //private variables
        private Party receiver;
        //public constructor
        public RejectionConfirmedFlowInitiator( Party receiver) {
        ...
        public SignedTransaction call() throws FlowException {
            ...
            String message = "I have the intention to reject the proposal, other party has already signed the decision.";
            ...
            final Party otherreceiver= ((Quote) inputStateAndRef.getState().getData()).getReceiver().get(0);
            final Quote output = new Quote(input.getId(), input.getQuote(),message,sender,Arrays.asList(receiver), true, true, false, true);
            ...
            builder.addCommand(new QuoteContract.Commands.RejectionConfirmed(), Arrays.asList(sender.getOwningKey(),receiver.getOwningKey()) );
    ...
    @InitiatedBy(RejectionConfirmedFlow.RejectionConfirmedFlowInitiator.class)
    public static class RejectionConfirmedFlowResponder extends FlowLogic<Void>{
        //private variable
        private FlowSession counterpartySession;

        //Constructor
        public RejectionConfirmedFlowResponder(FlowSession counterpartySession) {
            ...
            class SignTxFlow extends SignTransactionFlow {
                ...
                protected void checkTransaction(@NotNull SignedTransaction stx) throws FlowException {
                    ...
                    try {
                        ...
                        if(outputState.getSender().getName().equals("O=Supplier,L=Manchester,C=GB") || outputState.getSender().getName().equals("O=Bank,L=London,C=GB")){
                        ...
                        if(rec_of_prev_transaction.equals(outputState.getReceiver()) || send_of_prev_transaction.equals(outputState.getReceiver())){
                            throw new FlowException("I'm not receiver of first category");
                        }
